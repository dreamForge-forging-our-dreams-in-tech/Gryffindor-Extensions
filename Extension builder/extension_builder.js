...
class MyCoolAndAwesomeExtension {
    constructor(runtime) {
        this.runtime = runtime;
        // This code is generated by the Turbowarp Extension Builder extension. You can edit the blocks in the workspace to change this code.


        this.looks_say = this.runtime.getOpcodeFunction('looks_say');

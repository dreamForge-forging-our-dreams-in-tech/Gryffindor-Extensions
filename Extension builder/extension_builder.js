...
(async function (Scratch) {
    ...
    class definitionBlocks {
            ...
            while (currentId) {
                ...
                if (code_json && code_json[opcodeWithoutExtension]) {
                    ...
                    for (i of code_block) { // Replace any placeholders in the code block with the actual values from the block
                        ...
                        if(code_json[opcodeWithoutExtension].dependencies) {
                            let i;
                            for(i of code_json[opcodeWithoutExtension].dependencies) {
                                if(i ==+ 'runtime') {
                                    this.codeDependencies += 'Scratch.vm.runtime';
                                }
                            }
                        }
        ...
        updateCode(args, util) {
            ...
            Scratch.extensions.register(new ${extensionName}(${this.codeDependencies}));`;
